<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"C:\Users\Administrator\Desktop\file/application/index\view\whisper\index.html";i:1543742406;s:75:"C:\Users\Administrator\Desktop\file\application\index\view\index\index.html";i:1544326523;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="whisper-list">
            <div class="item-box">
                <div class="item">
                    ...
                    <div class="img-box">
                        <img src="/public/static/blog/img/wy_img1.jpg">
                    </div>
                    <div class="op-list">
                ...
                <div class="review-version layui-hide">
                    <div class="form">
                        <img src="/public/static/blog/img/header2.png">
                    ...
                    <div class="list-cont">
                        <div class="cont">
                            <div class="img">
                                <img src="/public/static/blog/img/header.png" alt="">
                            </div>
                            <div class="text">
            ...
            <div class="item-box">
                <div class="item">
                    ...
                    <div class="img-box">
                        <img src="/public/static/blog/img/wy_img2.jpg">
                        <img src="/public/static/blog/img/wy_img3.jpg">
                        <img src="/public/static/blog/img/wy_img4.jpg">
                    </div>
                    <div class="op-list">
                        <p class="like"><i class="layui-icon layui-icon-praise"></i><span>1200</span></p>
                        <p class="edit"><i class="layui-icon layui-icon-reply-fill"></i><span>1200</span></p>
            ...
            <div class="item-box">
                <div class="item">
                    ...
                    <div class="img-box">
                        <img src="/public/static/blog/img/wy_img5.jpg">
                    </div>
                    <div class="op-list">
                        <p class="like"><i class="layui-icon layui-icon-praise"></i><span>1200</span></p>
                        <p class="edit"><i class="layui-icon layui-icon-reply-fill"></i><span>1200</span></p>
